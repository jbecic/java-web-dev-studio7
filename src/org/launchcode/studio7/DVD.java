...
public class DVD extends BaseDisc implements OpticalDisc{
    ...
    public DVD(String type, int spin, double capacity, String read, String playBack) {
        super(type, spin, capacity, read, playBack);
    }

    @Override
    public void spinDisc() {
        System.out.println("A " + this.getType() + " spins at a rate of " + this.getSpin() + " - " + this.getSpin()*3 + " rpm.");
    }
    ...
    public void tellCapacity() {
        System.out.println("A " + this.getType() + " has a storage capacity of " + this.getCapacity() + " GB.");
    }
